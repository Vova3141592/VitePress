...
::: warning Внимание!
Если у вас уже есть приложения и расширения для обхода блокировок, отключите их: они могут мешать Streisand правильно работать.
:::
...
#### 3. Включите раздельную маршрутизацию <Badge type="info" text="Необязательно"/>
